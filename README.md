...
All the remaining classes (adbp.Branch, adbp.BranchList, adbp.MTLogLikelihood) attempt to extend the model to the multi-type case and **can be ignored for now**.
